...
const AuthedAppBrandBlueprintRoute = AuthedAppBrandBlueprintRouteImport.update({
  id: '/blueprint',
  path: '/blueprint',
  getParentRoute: () => AuthedAppBrandRoute,
} as any)
const AuthedAppBrandAgentPreferenceRoute =
  AuthedAppBrandAgentPreferenceRouteImport.update({
    id: '/agent-preference',
    path: '/agent-preference',
    getParentRoute: () => AuthedAppBrandRoute,
  } as any)
const AuthedAppBrandAgentOpsRoute = AuthedAppBrandAgentOpsRouteImport.update({
  id: '/agent-ops',
  path: '/agent-ops',
  getParentRoute: () => AuthedAppBrandRoute,
} as any)
const AuthedAppBrandAgentEntitiesRoute =
  AuthedAppBrandAgentEntitiesRouteImport.update({
    id: '/agent-entities',
    path: '/agent-entities',
    getParentRoute: () => AuthedAppBrandRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authed/app/$brand/blueprint': {
      id: '/_authed/app/$brand/blueprint'
      path: '/blueprint'
      fullPath: '/app/$brand/blueprint'
      preLoaderRoute: typeof AuthedAppBrandBlueprintRouteImport
      parentRoute: typeof AuthedAppBrandRoute
    }
    '/_authed/app/$brand/agent-preference': {
      id: '/_authed/app/$brand/agent-preference'
      path: '/agent-preference'
      fullPath: '/app/$brand/agent-preference'
      preLoaderRoute: typeof AuthedAppBrandAgentPreferenceRouteImport
      parentRoute: typeof AuthedAppBrandRoute
    }
    '/_authed/app/$brand/agent-ops': {
      id: '/_authed/app/$brand/agent-ops'
      path: '/agent-ops'
      fullPath: '/app/$brand/agent-ops'
      preLoaderRoute: typeof AuthedAppBrandAgentOpsRouteImport
      parentRoute: typeof AuthedAppBrandRoute
    }
    '/_authed/app/$brand/agent-entities': {
      id: '/_authed/app/$brand/agent-entities'
      path: '/agent-entities'
      fullPath: '/app/$brand/agent-entities'

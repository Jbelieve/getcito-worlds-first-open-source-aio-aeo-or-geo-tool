...
| 13 | **Borrar el parche del idioma** | `git revert 895216a` cuando mergee el PR #58 del upstream. **Verificado end-to-end el 2026-09-23 a las 08:32**: con el parche desplegado, el reporte de oportunidades se regeneró **en español** solo (se venció el caché y la app lo regeneró). El historial de `brand_opportunities` lo muestra: inglés (22/09 19:00) → español (23/09 06:20 y 06:23) → español regenerado por el código arreglado (23/09 08:32). |
...
| 12 | 🔴 **El techo de 90s tiraba respuestas VÁLIDAS de google-ai-mode** | Medido: google-ai-mode tiene **100% de éxito** con **promedio 48s pero máximo 303s**. Con el techo de 90s, todas las que tardaban más se descartaban en silencio — por eso una corrida dio 12 observaciones de 18. Con `google-ai-mode=360000` se recuperan. |
